-- =======================================================
-- Завдання №3: Запити до навчального датасету
-- =======================================================
...
-- Порядок за спаданням ціни, тільки 10 рядків.
...
-- 5: Знайти кількість продуктів та середню ціну у кожного постачальника (supplier_id)
SELECT
    supplier_id,
